...
// 2. FETCH USER & BACKGROUND DATA
// Get name/email from main users table
...
// Get profile details from user_background table
...
// 3. SAFE DEFAULTS (So page doesn't break if empty)
...
$headline_tags = val($bg, 'headline_tags', 'QA, Automation');
...
$skills_tags = val($bg, 'core_strengths_tags', 'Java, Selenium, SQL');
...
<div class="badges">
  ...
  <?php endforeach; ?>
  <span class="badge">Experience: 4+ years</span>
</div>
</div>
</div>
<div style="margin-top:1rem;" class="muted">
<!-- DYNAMIC ABOUT ME (Short) -->
<?= $about_me ?>
</div>
...
<?php if($github_url != '#'): ?><a href="<?= $github_url ?>" target="_blank" rel="noopener">GitHub</a><?php endif; ?>
<?php if($linkedin_url != '#'): ?><a href="<?= $linkedin_url ?>" target="_blank" rel="noopener">LinkedIn</a><?php endif; ?>
...
<div class="muted">
<!-- DYNAMIC CORE STRENGTHS / SUMMARY -->
<?= $core_strengths ?>
</div>
...
<!-- PROJECTS (Static for now, but links could be dynamic if you add project fields later) -->
<section id="projects" class="section">
<div class="section-title">
<h2>Projects</h2>
<p>Show problem → approach → stack → outcome. (Currently Static Portfolio Items)</p>
</div>
<div class="grid">
<article class="glass card col-6 project">
<div class="project-top">
<h3>Selenium POM Framework</h3>
<span class="tag good">Done</span>
</div>
<div class="muted">Reusable Page Object Model framework with utilities and stable locators to reduce test maintenance.</div>
<div class="skill-wrap" style="margin-top:.5rem;">
<span class="skill">Java</span>
<span class="skill">Selenium</span>
<span class="skill">Maven</span>
<span class="skill">TestNG/JUnit</span>
</div>
...
<article class="glass card col-6 project">
<div class="project-top">
<h3>API Test Collection</h3>
<span class="tag warn">In Progress</span>
</div>
<div class="muted">API suite with environments, negative cases, and schema checks for consistent verification.</div>
<div class="skill-wrap" style="margin-top:.5rem;">
...
<article class="glass card col-6 project">
<div class="project-top">
<h3>Nebula Portfolio Dashboard</h3>
<span class="tag good">Live</span>
</div>
<div class="muted">Authenticated dashboard-style portfolio with projects + settings to feel like a real product.</div>
<div class="skill-wrap" style="margin-top:.5rem;">
...
<?php if($linkedin_url != '#'): ?><a class="btn" href="<?= $linkedin_url ?>" target="_blank" rel="noopener">LinkedIn</a><?php endif; ?>
<?php if($github_url != '#'): ?><a class="btn" href="<?= $github_url ?>" target="_blank" rel="noopener">GitHub</a><?php endif; ?>
</div>
</div>
<div class="glass card col-6">
<h3>Downloads</h3>
<div class="muted">Keep these updated from your dashboard.</div>
<div style="margin-top:1rem; display:flex; gap:.7rem; flex-wrap:wrap;">
<a class="btn btn-primary" href="#">Download resume</a>
...
<footer>
© 2026 Nebula Portal — Full Profile page
</footer>
</div>
</body>
</html>
